	...
	<div id="joinForm">
		...
		<form action="" method="post" autocomplete="off">
			<div id="joinInputForm">
				...
				<div class="joinInputDiv">
					<div class="joinInputText">닉네임 <label class="requiredInput">*</label></div>
					<input type="text" id="nickInput" class="joinInput form-control" placeholder="2~6자의 한글로 입력해주세요." />
				</div>
				
				<div class="joinInputDiv">
					<div class="joinInputText">생년월일 <label class="requiredInput">*</label></div>
					<input type="date" id="birthInput" class="joinInput form-control" />
				</div>
				...
				<div class="joinInputDiv">
					<div class="joinInputText">주소 <label class="requiredInput">*</label></div>
				...
				<div class="joinInputDiv">
					<div class="joinInputText">성별 <label class="requiredInput">*</label></div>
					<label class="radio-inline">
						<input type="radio" name="genderRadioOptions" id="inlineRadio1" value="option1" checked="checked"> 여성
					</label>
					<label class="radio-inline">
						<input type="radio" name="genderRadioOptions" id="inlineRadio2" value="option2"> 남성
					</label>
				</div>
				
				<div class="joinInputDiv">
					<div class="joinInputText">바다낚시 시작 날짜(미기입시 가입일 기준으로 등록됩니다)</div>
					<input type="date" id="fishingStartDateInput" class="joinInput form-control" />
				</div>
			</div>
			
			<div class="form-group">
				<div>
					<a href="/login/userJoinSuccess"><button type="button" id="joinBtn">완료</button></a> <!-- 실제 개발시에는 회원가입 진행 컨트롤러로 연결해야함!! type도 submit으로 변경해야함 -->
